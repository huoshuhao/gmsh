                                      ...
                                      fullVector<double> &coeffSquare)
{
  ...
  if(&coeffA == &coeffB) {
    for(unsigned int ind = 0; ind < _raiser2New.size(); ++ind) {
      for(unsigned int l = 0; l < _raiser2New[ind].size(); ++l) {
                                      ...
                                      fullVector<double> &coeffCubic)
{
  ...
  if(&coeffA == &coeffB && &coeffB == &coeffC) {
    for(unsigned int ind = 0; ind < _raiser3New.size(); ++ind) {
      for(unsigned int l = 0; l < _raiser3New[ind].size(); ++l) {
