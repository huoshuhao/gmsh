...
StringXNumber GeometryOptions_Number[] = {
  ...
  { F|O, "OCCImportColors" , opt_geometry_occ_import_colors , 0. ,
    "Import colors from STEP models" },
  { F|O, "OCCImportMaterials" , opt_geometry_occ_import_materials , 0. ,
    "Import materials from STEP models as physical groups" },
